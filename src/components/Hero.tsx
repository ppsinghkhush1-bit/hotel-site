            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="group">
                <label className="flex items-center gap-2 text-sm font-bold text-white uppercase tracking-wide mb-3 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                  <Calendar size={18} className="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]" />
                  Check-in
                </label>
                <div className="relative">
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border-2 border-white/30 group-hover:border-white group-hover:bg-white/20 transition-all cursor-pointer shadow-2xl">
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">{checkInDate.day}</span>
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{checkInDate.month}</span>
                        <span className="text-xs text-white/95 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{checkInDate.year}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border-2 border-white/30 group-hover:border-white group-hover:bg-white/20 transition-all cursor-pointer shadow-2xl">
                    <div className="flex items-baseline gap-2">
                      <span className="text-5xl font-bold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">{checkOutDate.day}</span>
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{checkOutDate.month}</span>
                        <span className="text-xs text-white/95 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">{checkOutDate.year}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="group">
                <label className="flex items-center gap-2 text-sm font-bold text-white uppercase tracking-wide mb-3 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                  <Users size={18} className="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]" />
                  Guests
                </label>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border-2 border-white/30 group-hover:border-white group-hover:bg-white/20 transition-all shadow-2xl">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex flex-col items-center">
                      <span className="text-5xl font-bold text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">{filters.guests}</span>
                      <span className="text-xs text-white/95 mt-1 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] font-semibold">{filters.guests === 1 ? 'Guest' : 'Guests'}</span>
                    </div>
                    <button
                      type="button"
