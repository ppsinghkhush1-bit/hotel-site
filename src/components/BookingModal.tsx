            ...
            <div className="bg-neutral-900 text-white p-6 sm:p-8 lg:sticky lg:top-6 w-full lg:max-w-md max-h-screen lg:max-h-screen overflow-y-auto rounded-lg">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center justify-between bg-neutral-800 border border-neutral-700 rounded-lg px-6 py-4">
                  <button onClick={decrementGuests} disabled={bookingGuests <= 1} className="text-2xl text-white hover:text-emerald-400 transition-colors disabled:opacity-30 disabled:cursor-not-allowed">−</button>
                  <div className="flex items-center gap-3 text-white"><Users size={20} /><span className="font-bold text-2xl">{bookingGuests}</span></div>
                  <button onClick={incrementGuests} disabled={bookingGuests >= room.maxGuests} className="text-2xl text-white hover:text-emerald-400 transition-colors disabled:opacity-30 disabled:cursor-not-allowed">+</button>
                </div>
              </div>
